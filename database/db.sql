...
CREATE TABLE ORDERS (
    ...
    SUPPLIERID INT,
    ORDER_STATUS ENUM('NOT STARTED', 'COMPLETED') NOT NULL,
        -- NOT STARTED is when the admin places the order and the supplier has not completed it yet
        -- COMPLETED is when the supplier completes the order
...
CREATE TRIGGER protect_historical_price
...
CREATE TRIGGER calculate_sales_product_price
BEFORE INSERT ON SALES_PRODUCTS
FOR EACH ROW
BEGIN
    SET NEW.PRICE = NEW.UNIT_PRICE * NEW.QUANTITY;
END//
...
(1, 'Apple', 'Fresh red apples', 'Brand A', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/apples.jpeg?raw=true', 100, 20, 50, 0.19, 4),
(1, 'Banana', 'Ripe bananas', 'Brand B', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/bananas.jpg?raw=true', 100, 20, 50, 0.22, 4),
(1, 'Orange', 'Juicy oranges', 'Brand C', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/oranges.jpg?raw=true', 100, 20, 50, 0.35, 4),
...
(1, 'Pears', 'Crunchy pears', 'Brand K', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/pears.jpg?raw=true', 100, 20, 50, 0.47, 4),
...
(1, 'Mangoes', 'Sweet mangoes', 'Brand M', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/mangoes.jpeg?raw=true', 100, 20, 50, 1.31, 6);
...
(2, 'Lettuce', 'Crunchy lettuce', 'Brand B', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/lettuce.jpeg?raw=true', 100, 20, 50, 0.38, 4),
(2, 'Tomatoes', 'Juicy tomatoes', 'Brand C', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/tomatoes.jpeg?raw=true', 100, 20, 50, 0.94, 4),
(2, 'Onions', 'Fresh onions', 'Brand E', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/onions.jpeg?raw=true', 100, 20, 50, 0.23, 4),
(2, 'Potatoes', 'Tasty potatoes', 'Brand F', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/potatoes.jpeg?raw=true', 100, 20, 50, 0.12, 4),
(2, 'Kale', 'Leafy kale', 'Brand G', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/kale.jpeg?raw=true', 100, 20, 50, 0.74, 4),
(2, 'Mushrooms', 'Tasty mushrooms', 'Brand H', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/mushrooms.jpeg?raw=true', 100, 20, 50, 1.17, 4),
(2, 'Green Beans', 'Pods of green beans', 'Brand I', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/green%20beans.jpeg?raw=true', 100, 20, 50, 0.87, 4),
(2, 'Broccoli', 'Leafy broccoli', 'Brand J', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/broccoli.jpeg?raw=true', 100, 20, 50, 0.52, 4),
(2, 'Carrots', 'Crunchy carrots', 'Brand K', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/carrots.jpeg?raw=true', 100, 20, 50, 0.11, 4),
(2, 'Cucumbers', 'Cool cucumbers', 'Brand L', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/cucumbers.jpeg?raw=true', 100, 20, 50, 1.33, 6),
...
INSERT INTO PRODUCTS (CATEGORYID, PRODUCTNAME, PRODUCTDESCRIPTION, BRAND, PICTURE_URL, QUANTITY, REORDERLEVEL, REORDERQUANTITY, PRICE, WEIGHT) VALUES
(3, 'Chicken Thighs', 'Meaty chicken thighs', 'Brand A', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/chicken%20thighs.jpeg?raw=true', 100, 20, 50, 0.95, 80),
...
(3, 'Ham', 'Sliced cuts of ham', 'Brand H', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/ham.jpeg?raw=true', 100, 20, 50, 1.65, 72),
...
(3, 'Beef Brisket', 'Meaty beef brisket', 'Brand J', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/beef%20brisket.jpeg?raw=true', 100, 20, 50, 2.50, 112),
...
(3, 'Ground Beef', 'Meaty ground beef', 'Brand L', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/ground%20beef.jpeg?raw=true', 100, 20, 50, 1.80, 80),
(3, 'Salmon Fillet', 'Fresh salmon fillet', 'Brand M', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/salmon%20fillet.jpeg?raw=true', 100, 20, 50, 19.80, 24);
...
(4, 'Cheddar Cheese', 'Tasty cheddar cheese', 'Brand B', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/cheddar%20cheese.jpeg?raw=true', 100, 20, 50, 1.40, 20),
...
(4, 'Yogurt', 'Tasty yogurt', 'Brand E', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/yogurt.jpeg?raw=true', 100, 20, 50, 3.65, 24),
(4, 'Cream Cheese', 'Fresh cream cheese', 'Brand F', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/cream%20cheese.jpeg?raw=true', 100, 20, 50, 5.10, 24),
(4, 'Sour Cream', 'Tubs of sour cream', 'Brand G', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/sour%20cream.jpeg?raw=true', 100, 20, 50, 2.55, 20),
(4, 'Cottage Cheese', 'Fresh cottage cheese', 'Brand H', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/cottage%20cheese.jpeg?raw=true', 100, 20, 50, 2.85, 24),
(4, 'Heavy Cream', 'Thick heavy cream', 'Brand I', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/heavy%20cream.jpeg?raw=true', 100, 20, 50, 1.46, 8),
...
(4, 'Coconut Milk', 'Fresh coconut milk', 'Brand K', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/coconut%20milk.jpeg?raw=true', 100, 20, 50, 3.10, 24.5),
(4, 'Kefir', 'Healthy kefir', 'Brand L', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/Kefir.jpeg?raw=true', 100, 20, 50, 2.01, 12),
(4, 'Oat Milk', 'Vegan-friendly oat milk', 'Brand M', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/oat%20milk.jpeg?raw=true', 100, 20, 50, 1.02, 16);

INSERT INTO PRODUCTS (CATEGORYID, PRODUCTNAME, PRODUCTDESCRIPTION, BRAND, PICTURE_URL, QUANTITY, REORDERLEVEL, REORDERQUANTITY, PRICE, WEIGHT) VALUES
(5, 'Potato Chips', 'Crunchy potato chips', 'Brand A', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/potato%20chips.jpeg?raw=true', 100, 20, 50, 5.51, 16),
(5, 'Pretzels', 'Tasty pretzels', 'Brand B', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/pretzels.jpeg?raw=true', 100, 20, 50, 1.93, 4),
...
(5, 'Cookies', 'Sweet cookies', 'Brand E', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/cookies.jpeg?raw=true', 100, 20, 50, 1.23, 4.15),
(5, 'Brownies', 'Crispy brownies', 'Brand F', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/brownies.jpeg?raw=true', 100, 20, 50, 4.09, 16),
(5, 'Chocolate Bars', 'Tasty chocolate bars', 'Brand G', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/chocolate%20bars.jpeg?raw=true', 100, 20, 50, 3.27, 5),
(5, 'Jelly Beans', 'Assorted jelly beans', 'Brand H', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/jelly%20beans.jpeg?raw=true', 100, 20, 50, 1.22, 4),
(5, 'Gummy Bears', 'Assorted gummy bears', 'Brand I', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/gummy%20bears.jpeg?raw=true', 100, 20, 50, 1.58, 5),
...
(5, 'Popcorn', 'Crunchy popcorn', 'Brand K', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/popcorn.jpeg?raw=true', 100, 20, 50, 6.36, 10),
(5, 'Crackers', 'Crunchy crackers', 'Brand L', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/crackers.jpeg?raw=true', 100, 20, 50, 4.66, 10),
(5, 'Peanuts', 'Healthy peanuts', 'Brand M', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/peanuts.jpeg?raw=true', 100, 20, 50, 2.32, 12);

INSERT INTO PRODUCTS (CATEGORYID, PRODUCTNAME, PRODUCTDESCRIPTION, BRAND, PICTURE_URL, QUANTITY, REORDERLEVEL, REORDERQUANTITY, PRICE, WEIGHT) VALUES
(6, 'Chicken Nuggets', 'Crispy chicken nuggets', 'Brand A', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/chicken%20nuggets.jpeg?raw=true', 100, 20, 50, 3.80, 20),
(6, 'Chicken Tikka Masala', 'Tasty chicken tikka masala', 'Brand B', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/chicken%20tikka%20masala.jpeg?raw=true', 100, 20, 50, 5.10, 10),
(6, 'Frozen Peas', 'Tasty frozen peas', 'Brand C', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/frozen%20peas.jpeg?raw=true', 100, 20, 50, 2.15, 20),
...
(6, 'Spaghetti', 'Tasty spaghetti', 'Brand G', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/spaghetti.jpeg?raw=true', 100, 20, 50, 11.19, 10),
(6, 'Taquitos', 'Tasty taquitos', 'Brand H', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/taquitos.jpeg?raw=true', 100, 20, 50, 3.16, 11),
...
(6, 'Frozen Salad', 'Tasty frozen salad', 'Brand K', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/frozen%20salad.jpeg?raw=true', 100, 20, 50, 6.55, 11.22),
...
(6, 'Yakisoba', 'Tasty yakisoba', 'Brand M', 'https://github.com/rohithj7/OFS/blob/preethi/client/public/Assets/yakisoba.jpeg?raw=true', 100, 20, 50, 2.75, 9);
